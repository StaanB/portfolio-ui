...
const About = () => {
  return (
    <div
      id="about"
      className="w-11/12 m-auto mt-56 md:mt-[60vh] xl:mt-20 flex flex-col-reverse xl:flex-row h-[90vh] xl:h-[85vh]"
    >
      <div className="flex flex-col justify-center items-center text-center">
        ...
        >
          ...
          <p className="text-md text-justify mt-5 mb-10">
        ...
        <div className="w-full xl:w-1/2 mb-5 xl:mb-0 flex flex-col text-start justify-center">
          <motion.div
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
      ...
      <div className="w-full xl:w-1/2 m-auto xl:flex items-center">
        <motion.img
          ...
          src={mePicture}
          alt="Stanley-2"
          className="object-cover w-full md:w-[30rem] xl:w-[40rem] h-[20rem] md:h-[30rem] xl:h-[40rem] m-auto rounded-full"
        />
      </div>
    </div>
  );
